...
export const SCHOOL_DATA: School[] = [
  {
    ...
    youtubeThumbnail: 'https://static.vecteezy.com/system/resources/thumbnails/048/682/339/small/closeup-of-muslim-children-in-elegant-attire-reciting-the-quran-showcasing-their-devotion-and-cultural-heritage-generated-image-photo.jpg',
    youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    gallery: [
      { url: 'https://picsum.photos/seed/sd-gal1/400/300', title: 'Peringatan Hari Kartini', description: 'Siswa-siswi mengenakan pakaian adat untuk merayakan semangat emansipasi.', date: '21 April 2023' },
      { url: 'https://picsum.photos/seed/sd-gal2/400/300', title: 'Kegiatan Pramuka Ceria', description: 'Membangun karakter mandiri dan kerjasama melalui kegiatan kepramukaan.', date: '14 Agustus 2023' },
      { url: 'https://picsum.photos/seed/sd-gal3/400/300', title: 'Lomba Mewarnai', description: 'Mengasah kreativitas dan imajinasi anak-anak dalam lomba mewarnai tingkat sekolah.', date: '17 September 2023' },
      { url: 'https://picsum.photos/seed/sd-gal4/400/300', title: 'Manasik Haji Cilik', description: 'Pengenalan ibadah haji sejak dini melalui praktik manasik yang menyenangkan.', date: '10 Juni 2023' },
      { url: 'https://picsum.photos/seed/sd-gal5/400/300', title: 'Class Meeting Akhir Semester', description: 'Mempererat kekompakan antar siswa melalui berbagai perlombaan olahraga dan seni.', date: '15 Desember 2023' },
      { url: 'https://picsum.photos/seed/sd-gal6/400/300', title: 'Kunjungan Edukatif', description: 'Siswa mengunjungi perpustakaan daerah untuk menumbuhkan minat baca.', date: '05 November 2023' },
    ],
    achievements: [
      {
        image: 'https://cdn3d.iconscout.com/3d/premium/thumb/trophy-3d-icon-png-download-3337288@0.png',
  ...
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    gallery: [
      { url: 'https://picsum.photos/seed/smp-gal1/400/300', title: 'Workshop Robotik', description: 'Siswa belajar merakit dan memprogram robot dalam workshop interaktif.', date: '12 Oktober 2023' },
      { url: 'https://picsum.photos/seed/smp-gal2/400/300', title: 'Pentas Seni Tahunan', description: 'Ajang kreativitas siswa dalam menampilkan pertunjukan musik, tari, dan drama.', date: '20 November 2023' },
      { url: 'https://picsum.photos/seed/smp-gal3/400/300', title: 'Studi Tur Sejarah', description: 'Mengunjungi situs-situs bersejarah untuk pembelajaran langsung di lapangan.', date: '08 September 2023' },
      { url: 'https://picsum.photos/seed/smp-gal4/400/300', title: 'Latihan Dasar Kepemimpinan', description: 'Membentuk jiwa pemimpin yang tangguh dan bertanggung jawab pada siswa.', date: '22 Juli 2023' },
      { url: 'https://picsum.photos/seed/smp-gal5/400/300', title: 'Bakti Sosial Masyarakat', description: 'Menumbuhkan rasa kepedulian sosial melalui kegiatan bakti sosial di lingkungan sekitar.', date: '18 Agustus 2023' },
      { url: 'https://picsum.photos/seed/smp-gal6/400/300', title: 'Final Kompetisi Basket', description: 'Pertandingan sengit di final liga basket antar kelas yang penuh semangat.', date: '02 Desember 2023' },
    ],
    achievements: [
      {
        image: 'https://cdn3d.iconscout.com/3d/premium/thumb/trophy-3d-icon-png-download-3337288@0.png',
  ...
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    gallery: [
      { url: 'https://picsum.photos/seed/smk-gal1/400/300', title: 'Praktik Bengkel Otomotif', description: 'Siswa jurusan TKR sedang melakukan praktik servis kendaraan di bengkel sekolah.', date: '15 Oktober 2023' },
      { url: 'https://picsum.photos/seed/smk-gal2/400/300', title: 'Lomba Kompetensi Siswa', description: 'Peserta dari jurusan Desain Grafis sedang berkompetisi di tingkat provinsi.', date: '03 November 2023' },
      { url: 'https://picsum.photos/seed/smk-gal3/400/300', title: 'Kunjungan Industri', description: 'Siswa melakukan kunjungan ke perusahaan teknologi untuk melihat dunia kerja.', date: '25 September 2023' },
      { url: 'https://picsum.photos/seed/smk-gal4/400/300', title: 'Workshop Digital Marketing', description: 'Pelatihan intensif bersama praktisi industri mengenai strategi SEO dan media sosial.', date: '11 November 2023' },
      { url: 'https://picsum.photos/seed/smk-gal5/400/300', title: 'Ujian Praktik Kejuruan', description: 'Siswa menunjukkan keahlian mereka di hadapan penguji eksternal dari industri.', date: '18 Maret 2024' },
      { url: 'https://picsum.photos/seed/smk-gal6/400/300', title: 'Bursa Kerja Sekolah', description: 'Puluhan perusahaan berpartisipasi dalam bursa kerja yang diadakan di kampus.', date: '22 April 2024' },
    ],
    achievements: [
      {
        image: 'https://cdn3d.iconscout.com/3d/premium/thumb/trophy-3d-icon-png-download-3337288@0.png',
  ...
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    gallery: [
      { url: 'https://picsum.photos/seed/yayasan-gal1/400/300', title: 'Santunan Anak Yatim', description: 'Kegiatan rutin bulanan berbagi kebahagiaan bersama anak-anak yatim piatu.', date: 'Setiap 10 Muharram' },
      { url: 'https://picsum.photos/seed/yayasan-gal2/400/300', title: 'Program Desa Binaan', description: 'Yayasan memberikan pelatihan keterampilan kepada warga desa binaan.', date: '15 Juni 2023' },
      { url: 'https://picsum.photos/seed/yayasan-gal3/400/300', title: 'Seminar Pendidikan Nasional', description: 'Mengundang para pakar untuk membahas masa depan pendidikan Islam di Indonesia.', date: '25 Agustus 2023' },
      { url: 'https://picsum.photos/seed/yayasan-gal4/400/300', title: 'Peresmian Gedung Baru', description: 'Peresmian gedung sekolah baru untuk meningkatkan kapasitas dan fasilitas belajar.', date: '19 Januari 2024' },
      { url: 'https://picsum.photos/seed/yayasan-gal5/400/300', title: 'Wisuda Akbar Santri', description: 'Momen kelulusan santri penghafal Al-Qur\'an dari seluruh unit pendidikan.', date: '28 Mei 2023' },
      { url: 'https://picsum.photos/seed/yayasan-gal6/400/300', title: 'Rapat Kerja Tahunan', description: 'Seluruh pimpinan unit membahas evaluasi dan rencana strategis yayasan.', date: '05 Januari 2024' },
    ],
    achievements: [
      {
        image: 'https://cdn3d.iconscout.com/3d/premium/thumb/trophy-3d-icon-png-download-3337288@0.png',
